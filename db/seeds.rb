...
customer1  = Customer.create(name: "Linus Torvalds", password: "password", email: "email@email.com")
customer2  = Customer.create(name: "Alan Turing", password: "password", email: "email@email.com")
customer3  = Customer.create(name: "Ada Lovelace", password: "password", email: "email@email.com")
customer4  = Customer.create(name: "DHH", password: "password", email: "email@email.com")
customer5  = Customer.create(name: "Yukihiro Matsumoto", password: "password", email: "email@email.com")
customer6  = Customer.create(name: "Eli Manning", password: "password", email: "email@email.com")
customer7  = Customer.create(name: "Odell Beckham Jr.", password: "password", email: "email@email.com")
customer8  = Customer.create(name: "LeBron James", password: "password", email: "email@email.com")
customer9  = Customer.create(name: "Lindsey Vonn", password: "password", email: "email@email.com")
customer10 = Customer.create(name: "Clint Dempsey", password: "password", email: "email@email.com")
